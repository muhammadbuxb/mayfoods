        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    <h1 class="fw-bold text-primary mb-4">May F<span class="text-secondary">oo</span>ds</h1>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p><a href="https://www.google.com/maps/?cid=1960018890830958322">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a href="#">May Foods</a>, All Right Reserved.
                    </div>
